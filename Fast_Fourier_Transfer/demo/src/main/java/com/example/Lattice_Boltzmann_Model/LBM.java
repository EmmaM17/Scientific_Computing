package com.example.Lattice_Boltzmann_Model;
...
public class LBM {
    ...
    final static int NITER = 35000 ;

    final static int NX = 520, NY = 180 ;  // Lattice dimensions
    final static int Q = 9 ;  // num states
     
    final static double uLB = 0.03 ;  // Inlet velocity in lattice units -0.06

    final static double Re = 330.0 ;  // Reynolds number -330.0
    ...
    public static void lbm(String args []) throws Exception {
        ...
        double omega = 1.0 / (3 * nulb + 0.5) ;  // Relaxation parameter   1/T
