...
public class HPP {
    ...
    final static int DELAY = 1000 ; //500
    ...
    public static void hpp(String args []) throws Exception {
        ...
        for(int i = 0; i <NX ; i++){
            for(int j = 0; j < NY; j++){ // no they can generate randomly anywnhere on the grid
                boolean [] fin_ij = fin [i] [j] ;
                for(int d = 0 ; d < q ; d++) {
        ...
        for(int iter = 0 ; iter < NITER ; iter++) {
            ...
            for(int i = 0; i < NX ; i++) { 
                for(int j = 0; j < NY ; j++) { 
                    ...
                    if(fin_ij[0] == true && fin_ij[1] == true  && fin_ij[2] == false && fin_ij[3] == false){
                    ...
                    } else if (fin_ij[0] == false && fin_ij[1] == false && fin_ij[2] == true && fin_ij[3] == true){
            ...
            for(int i = 0; i < NX ; i++) { 
                ...
                for(int j = 0; j < NY ; j++) { 
                    ...
                    // Streaming step: particles move to their corresponding neighboring nodes
                    fin[i][j][0] = fout[iP1][j][0]; // Moving left neighbor to current
                    fin[i][j][1] = fout[iM1][j][1]; // Moving right neighbor to current
                    fin[i][j][2] = fout[i][jP1][2]; // Moving downward neighbor to current
                    fin[i][j][3] = fout[i][jM1][3]; // Moving upward neighbor to current
                }
            }
