package com.example.Sky_Imaging;
import java.awt.* ;
import javax.swing.* ;
...
public class Imaging {
    ...
    public static void imaging(String [] args) throws IOException { 
        ...
        BufferedReader in = new BufferedReader(
                new InputStreamReader(new FileInputStream("Fast_Fourier_Transfer\\demo\\src\\main\\java\\com\\example\\Sky_Imaging\\vis-and-uv.txt"))) ;
